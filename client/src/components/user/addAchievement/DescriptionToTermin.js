  ...
  render() {
    ...
    if (values.some((o) => o === 'СДнСК')) {
      ...
      return (<div id="descr_'+n+'" className="blue_bg"><p className="desc_selectors" id="desc_criterion_first">
        ...
        <a target="_blank" href="http://www.scimagojr.com/journalsearch.php" rel="noreferrer" >Узнать квартиль для
                    SCOPUS </a><br/>
        <a target="_blank" href="http://www.isiknowledge.com" rel="noreferrer" >Узнать квартиль для WoS</a> <br/>
      </p></div>);
