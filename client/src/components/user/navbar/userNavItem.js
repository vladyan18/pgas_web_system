...
const linkComponentCSS = css`margin-left: 0.25rem;`;
  ...
  render() {
    ...
    return (
      <li css={[navElement, isActive && activeElement]}>
        <LinkComponent css={linkComponentCSS} to={to} {...props} onMouseEnter={onHover} onClick={onClick}>{children}</LinkComponent>
      </li>
    );
  }
}
