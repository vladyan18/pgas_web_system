...
} catch (c) {} const l=(c.navigator||{}).userAgent; const h=void 0===l?'':l; const v=c; const m=z; const a=(v.document, !!m.documentElement&&!!m.head&&'function'==typeof m.addEventListener&&m.createElement, ~h.indexOf('MSIE')||h.indexOf('Trident/'), '___FONT_AWESOME___'); const M=function() {
try {
return !0;
} catch (c) {
return !1;
}
}(); const s=v||{}; s[a]||(s[a]={}), s[a].styles||(s[a].styles={}), s[a].hooks||(s[a].hooks={}), s[a].shims||(s[a].shims=[]); const H=s[a]; function f(c, h) {
const z=(2<arguments.length&&void 0!==arguments[2]?arguments[2]:{}).skipHooks; const l=void 0!==z&&z; const v=Object.keys(h).reduce(function(c, z) {
const l=h[z]; return l.icon?c[l.iconName]=l.icon:c[z]=l, c;
